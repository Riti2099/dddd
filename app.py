        ...
        while stream_active:
            ...
            for rect in rects:
                ...
                for rect in rects:
                    shape = predictor(gray, rect)
                    shape = face_utils.shape_to_np(shape)
                    # Extract jawline and nose points
                    jawline = shape[0:17]  # Jawline point
                    nose = shape[27:36]    # Nose points
                    # Draw jawline and nose
                    cv2.polylines(frame, [jawline], False, (255, 0, 0), 1)
                    cv2.polylines(frame, [nose], True, (0, 255, 255), 1)
